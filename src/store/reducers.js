...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_THFJHFK_LIST:
    case types.API_V1_THFJHFK_LIST_SUCCEEDED:
    case types.API_V1_THFJHFK_LIST_FAILED:
    case types.API_V1_THFJHFK_CREATE:
    case types.API_V1_THFJHFK_CREATE_SUCCEEDED:
    case types.API_V1_THFJHFK_CREATE_FAILED:
    case types.API_V1_THFJHFK_READ:
    case types.API_V1_THFJHFK_READ_SUCCEEDED:
    case types.API_V1_THFJHFK_READ_FAILED:
    case types.API_V1_THFJHFK_UPDATE:
    case types.API_V1_THFJHFK_UPDATE_SUCCEEDED:
    case types.API_V1_THFJHFK_UPDATE_FAILED:
    case types.API_V1_THFJHFK_PARTIAL_UPDATE:
    case types.API_V1_THFJHFK_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_THFJHFK_PARTIAL_UPDATE_FAILED:
    case types.API_V1_THFJHFK_DELETE:
    case types.API_V1_THFJHFK_DELETE_SUCCEEDED:
    case types.API_V1_THFJHFK_DELETE_FAILED:
